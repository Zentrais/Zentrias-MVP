...
export default function ReviewsPage() {
  ...
  useEffect(() => {
    ...
    if (mainElement) {
      ...
      (mainElement as HTMLElement).style.minHeight = '100vh';
    }
    return () => {
      document.body.style.backgroundColor = 'transparent';
      if (mainElement) {
        (mainElement as HTMLElement).style.backgroundColor = '';
        (mainElement as HTMLElement).style.minHeight = '';
      }
    };
  }, []);

  return (
    <div className="text-white relative flex flex-col w-full" style={{ backgroundColor: '#36454F', marginTop: '-64px', paddingTop: '64px', minHeight: '100vh', width: '100%', height: '100%' }}>
      {/* Fondo animado sutil */}
