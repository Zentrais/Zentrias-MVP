        ...
        >
          ...
          <div className="mt-0 sm:mt-1 md:mt-2 flex flex-col items-center animate-fade-in-up animation-delay-750" style={{ contain: 'layout style', isolation: 'isolate', position: 'relative', zIndex: 10, overflow: 'visible' }}>
            <div className="relative mx-auto w-full max-w-5xl" style={{ isolation: 'isolate', transform: 'translateZ(0)', backfaceVisibility: 'hidden', overflow: 'visible', position: 'relative' }}>
              ...
              <Link 
                href="https://app.zentrais.com/onboarding"
          ...
          <div 
            ...
            style={{ transform: 'translateZ(0)', backfaceVisibility: 'hidden', contain: 'layout style' }}
          >
            <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 text-center text-white/70 text-sm sm:text-base px-4 sm:px-0">
              <div className="flex items-start sm:items-center gap-2 group/proof hover:text-white transition-opacity max-w-full sm:w-auto" style={{ transitionDuration: '200ms' }}>
                <span 
                  className="inline-block w-2 h-2 bg-cyan-400 rounded-full opacity-80 group-hover/proof:opacity-100 transition-opacity flex-shrink-0 mt-1.5 sm:mt-0"
                  style={{ transform: 'translateZ(0)', backfaceVisibility: 'hidden', transitionDuration: '200ms' }}
                ></span>
                <span className="font-semibold text-white/90 group-hover/proof:scale-105 transition-transform sm:whitespace-nowrap text-left sm:text-center break-words sm:break-normal" style={{ transform: 'translateZ(0)', transitionDuration: '200ms', wordBreak: 'break-word' }}>{t('home.proof.builders')}</span>
              </div>
              <div className="flex items-start sm:items-center gap-2 group/proof hover:text-white transition-opacity max-w-full sm:w-auto" style={{ transitionDuration: '200ms' }}>
                <span 
                  className="inline-block w-2 h-2 bg-purple-400 rounded-full opacity-80 group-hover/proof:opacity-100 transition-opacity flex-shrink-0 mt-1.5 sm:mt-0"
                  style={{ transform: 'translateZ(0)', backfaceVisibility: 'hidden', transitionDuration: '200ms' }}
                ></span>
                <span className="font-semibold text-white/90 group-hover/proof:scale-105 transition-transform sm:whitespace-nowrap text-left sm:text-center break-words sm:break-normal" style={{ transform: 'translateZ(0)', transitionDuration: '200ms', wordBreak: 'break-word' }}>{t('home.proof.founders')}</span>
              </div>
              <div className="flex items-start sm:items-center gap-2 group/proof hover:text-white transition-opacity max-w-full sm:w-auto" style={{ transitionDuration: '200ms' }}>
                <span 
                  className="inline-block w-2 h-2 bg-pink-400 rounded-full opacity-80 group-hover/proof:opacity-100 transition-opacity flex-shrink-0 mt-1.5 sm:mt-0"
                  style={{ transform: 'translateZ(0)', backfaceVisibility: 'hidden', transitionDuration: '200ms' }}
                ></span>
                <span className="font-semibold text-white/90 group-hover/proof:scale-105 transition-transform sm:whitespace-nowrap text-left sm:text-center break-words sm:break-normal" style={{ transform: 'translateZ(0)', transitionDuration: '200ms', wordBreak: 'break-word' }}>{t('home.proof.beta')}</span>
              </div>
            </div>
          </div>
        </div>
