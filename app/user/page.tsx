...
export default function UserPage() {
  ...
  const handleJoinBeta = () => {
    window.location.href = 'https://app.zentrais.com/onboarding';
  };
  ...
  return (
    <div className="min-h-screen relative overflow-hidden user-tone" style={{ transform: 'translateZ(0)', contain: 'layout style paint' }}>
      ...
      <section className="relative z-10 container mx-auto px-4 sm:px-6 pt-12 sm:pt-16 md:pt-20 pb-12 sm:pb-16 md:pb-24">
